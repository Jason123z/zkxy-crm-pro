...
def read_contacts(customer_id: str, user_id: str = Depends(get_current_user_id), service: CustomerService = Depends(get_service)):
    return service.get_contacts_by_customer(customer_id, user_id)
...
def read_visits(customer_id: str, user_id: str = Depends(get_current_user_id), service: CustomerService = Depends(get_service)):
    return service.get_visits_by_customer(customer_id, user_id)
...
def read_tasks(customer_id: str, user_id: str = Depends(get_current_user_id), service: CustomerService = Depends(get_service)):
    return service.get_tasks_by_customer(customer_id, user_id)
