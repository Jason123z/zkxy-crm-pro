...
// 定义页面类型
type Page = 'login' | 'dashboard' | 'customers' | 'customer-details' | 'report' | 'profile' | 'checkin' | 'visit-plan' | 'add-customer';
  ...
  const renderPage = () => {
    switch (currentPage) {
      ...
      case 'customer-details':
        return <CustomerDetails customerId={selectedCustomerId} onBack={handleBackToCustomers} onShowToast={showToast} />;
      case 'report':
